...
class theme_tresipunt_block_course_overview_renderer extends block_course_overview_renderer {
    ...
    public function course_overview($courses, $overviews) {
        ...
        foreach ($courses as $key => $course) {
            ...
            if ($coursecoverlink) {
                $html .= html_writer::start_tag('div', array('class' => 'course-image thumbnail', 'style' => 'position: relative;  width: 100%;  height: 150px;  overflow: hidden;'));
                $html .= html_writer::tag($nametag, $coursecoverlink, array('class' => ''));
            ...
            if ($course->id > 0) {
                ...
                $html .= $this->output->heading($link, 3, 'coursename');
            } else {
        ...
        return html_writer::tag('div', $html, array('class' => 'course_list3333'));
    }
}
